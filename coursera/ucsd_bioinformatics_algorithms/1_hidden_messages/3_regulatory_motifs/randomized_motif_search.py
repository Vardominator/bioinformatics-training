...
RandomizedMotifSearch(dna, 3, 4)

# with open('data/dataset_161_5.txt', 'r') as stream:
#     k, t = stream.readline().split(' ')
...
# with open('data/dataset_161_5_result.txt', 'w') as stream:
#     for bm in last_motifs:
#         stream.write(bm + '\n')
#     # stream.writelines(bms)